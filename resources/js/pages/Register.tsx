                ...
                <div className='flex flex-col bg-white px-[50px] rounded-[8px] py-[65px] gap-[30px]'>
                    ...
                    <form className='flex flex-col gap-[20px]'>
                        ...
                        <div className='flex flex-col gap-[10px]'>
                            <label className='text-[15px] font-[500] leading-[28px] text-[#222]'>First Name *</label>
                            <input className='border-[#e9e9e9] h-[55px] rounded-[4px] border pl-[10px]' placeholder='Email' />
                        </div>
                        <div className='flex flex-col gap-[10px]'>
                            <label className='text-[15px] font-[500] leading-[28px] text-[#222]'>Last Name *</label>
                            <input className='border-[#e9e9e9] h-[55px] rounded-[4px] border pl-[10px]' type='password' placeholder='Password' />
                        </div>
                        <div className='flex flex-col gap-[10px]'>
                            <label className='text-[15px] font-[500] leading-[28px] text-[#222]'>Email *</label>
                            <input className='border-[#e9e9e9] h-[55px] rounded-[4px] border pl-[10px]' placeholder='Email' />
                        </div>
                        <div className='flex flex-col gap-[10px]'>
                        ...
                        <div className='flex flex-col gap-[10px]'>
                            <label className='text-[15px] font-[500] leading-[28px] text-[#222]'>Confirm Password *</label>
