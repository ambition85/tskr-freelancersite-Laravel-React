    ...
    <div className='flex pt-[20px] pb-[20px] pl-[30px] pr-[30px] w-full h-[80px] bg-[#222]'>
      ...
      <div className="flex justify-end w-[50%]">
        ...
        <div className="flex justify-end gap-[20px]">
          ...
          <Link className="font-sans text-[15px] font-[700] leading-[28px] text-[#fff] hover:text-[#5BBB7B] pt-[4px] pb-[4px] pl-[15px] pr-[15px]" to="/login">Login</Link>
          <Link className="font-sans text-[15px] font-[700] leading-[28px] text-[#fff] hover:text-[#222] hover:bg-[#FFF] pt-[4px] pb-[4px] pl-[15px] pr-[15px] bg-[#5BBB7B] rounded-[4px]" to="/register">Sign Up</Link>
        </div>
      </div>
    </div>
  )
